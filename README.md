...
| master                | biduofeng      |
| --------------------- | -------------- |
| huntertrades 公司代码 | 币多分公司代码 |

### 系统介绍

| boss                 | h-mobile         | h-off   | hTrade       | mobile                        |
| -------------------- | ---------------- | ------- | ------------ | ----------------------------- |
| 原管理系统，暂无使用 | 手机端官网及注册 | pc 官网 | 运营管理系统 | 原手机策略设置系统， 暂无使用 |
...
| ---------------------------------------- | ----------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------ |
| 需要打包的项目名称, 如: hTrade, h-off 等 | 公司名称, 默认是 hTrade(自己公司), 其他: 币多分 | 接口设置代理的 url, dev 是链接开发环境, 两者冲突, 优先级是 target | 接口链接开发环境, 有 target 是不生效 |
